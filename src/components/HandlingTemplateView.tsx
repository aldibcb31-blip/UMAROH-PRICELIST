...
import { Calendar, RefreshCw, Download, MapPin, DollarSign, Wand2, Sparkles } from 'lucide-react';
...
export const HandlingTemplateView: React.FC = () => {
  ...
  const handleAIApply = (data: any) => {
    ...
    if (data.paxRows !== undefined) setPaxRows(data.paxRows);
    if (data.includeRows !== undefined) setIncludeRows(data.includeRows);
  };
